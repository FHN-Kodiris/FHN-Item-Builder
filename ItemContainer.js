...
class ItemContainer{
    constructor(container, itemName, image, div){
...
function newItemContainer(){
    ...
    var newContainer = new ItemContainer(itemContainer, itemName, image, div);

    newContainer.setName("item name");
    newContainer.setImage("none");
